...
STOCK_API_KEY = "02dba3926eb94414afdd855d67ef0bd1"
...
difference = float(yest_closing_price) - float(day_before_yest_closing_price)
print(difference)

# Work out the percentage difference in price between closing price yesterday and closing price the day before yesterday.
diff_percent = (difference/float(yest_closing_price))*100
print(diff_percent)
